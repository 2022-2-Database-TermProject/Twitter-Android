...
import com.database_termproject.twitter.ui.post.PostAlbumRVAdapter
...
class HomePostRVAdapter(val context: Context) : RecyclerView.Adapter<HomePostRVAdapter.ViewHolder>() {
    ...
    private lateinit var homePostImageRVAdapter: HomePostImageRVAdapter
    ...
    inner class ViewHolder(val binding: ItemPostBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(post: Post){
            ...
            homePostImageRVAdapter = HomePostImageRVAdapter(context, post.fileList)
